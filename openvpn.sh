...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	clear
	echo "Welcome to this quick OpenVPN Auto Installer"
	echo "Updated automation by Mohammed Ali (PrismaTechwork.com)"
	echo "https://github.com/mhmdali94"
	echo ""
	...
	# Generate TLS auth key (fixed: no longer using deprecated --genkey --secret)
...
EOF
	...
	# Note: comp-lzo replaced with compress lz4-v2 (comp-lzo removed in newer OpenVPN)
	cat >> /etc/openvpn/server.conf <<EOF
keepalive 10 120
cipher AES-256-CBC
compress lz4-v2
...
exit 0' > $RCLOCAL
	...
	# Detect NAT and ask for external IP if needed
	...
	# Note: comp-lzo replaced with compress lz4-v2
